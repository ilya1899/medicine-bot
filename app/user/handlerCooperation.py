...
# async def callback_forDoctors(callback: CallbackQuery):
...
# ''', reply_markup=kbInline.submitRequest1)
#
#
# @router.callback_query(F.data == 'submitRequest1')
# async def callback_submitRequest1(callback: CallbackQuery):
#     await callback.message.edit_text(
#         'Продолжая пользоваться сервисом вы подтверждаете, что ознакомились с <b><a href="https://docs.google.com/document/d/10xzfOSIhNGLcnTpEtv_b9QCyP5EFMPyv7JBowQWXjcU/edit?tab=t.0">лицензионным соглашением</a></b>.',
#         reply_markup=kbInline.submitRequest2, parse_mode='html')
#
#
# @router.callback_query(F.data == 'submitRequest2')
